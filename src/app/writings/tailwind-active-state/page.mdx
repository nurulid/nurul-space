export const metadata = {
  ...
  keyword: "ui writing, ui blog, ui web tutorial, ui tutorial, ui tips, tailwind css, tailwind, tailwindcss, tailwind ui, tailwind active, tailwind active class, tailwind active state"
};
